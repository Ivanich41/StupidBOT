...
Для создания токена и первичной настройки  бота посетите портал разработчика Discord
https://discord.com/developers/applications и создайте новое приложение.
## Пример 
```python
TOKEN = 'example'
```
